...
function edit_event_details() 
{
    ...
    if($user->roles[0] == "contributor"||$user->roles[0] == "administrator")
    {
        ...
        {
            $_POST['active_field'];
            processText($_POST['event_name_field']);
            processText($_POST['event_description_field']);
            processText($_POST['company_url_field']);
            
            processText($_POST['contact_person_field']);
            $_POST['email_field'];
            processText($_POST['contact_number_field']);
            processText($_POST['company_name_field']);
            processText($_POST['ecommerce_url_field']);
            processText($_POST['catalogue_url_field']);
            processText($_POST['video_url_field']);
            processText($_POST['live_stream_url_field']);
            ...
            update_post_meta($_POST['current_post_id'], "booth_type", processText($_POST['booth_field']));
            ...
            {
                $banner_img = upload_to_media($_FILES['banner_image_field']);
